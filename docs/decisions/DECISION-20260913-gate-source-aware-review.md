# ⚠️ 本决策已被 DECISION-20260915 取代（2026-09-15）
>
> 「源长×(0.25,0.45) 参考带」已被离线审计证伪（与源质量无稳定因果，同一批
> 语音识别稿里长源报「偏短」、短源报「超参考值」，跨度近 10 倍）。现行规则见
> `docs/decisions/DECISION-20260915-content-first-gate.md`。
> 本文件仅作历史记录，**勿据此实现或调参**。
