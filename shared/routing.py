...
# 笔记类型标签（2026-09-13 起裸标签化，如 #结构化复盘）也作分类跳过项——
# 体裁维度与落盘「分类」（主题文件夹）正交，裸化后若某路径把最终标签传入 category 解析也不抢分类。
_TYPE_LABELS = {"结构化复盘", "要点提炼", "访谈实录", "选题合集",
                "读书笔记", "案例拆解", "观点随笔", "创作解剖"}
CATEGORY_SKIP_TAGS = {"文章总结", "转载", "总结", "笔记",
                      "动态速览", "短动态", "🔥当日", "本周", "更早"} | _TYPE_LABELS
